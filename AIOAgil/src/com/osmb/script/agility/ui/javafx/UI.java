...
import com.osmb.script.agility.pollnivneach.Pollnivneach;
...
public class UI {
    ...
    public Scene open() {
        ...
        selectCourseComboBox.getItems().addAll(new GnomeStronghold(), new Draynor(), new AlKharid(), new Varrock(), new Canafis(), new Falador(), new Seers(), new Pollnivneach());
        ...
        hBox.getChildren().addAll(itemIDLabel, itemIDTextField);
